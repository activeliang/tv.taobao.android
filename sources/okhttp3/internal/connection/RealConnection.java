...
public final class RealConnection extends Http2Connection.Listener implements Connection {
    ...
    private void connectTls(okhttp3.internal.connection.ConnectionSpecSelector r16) throws java.io.IOException {
        /*
            ...
            okhttp3.HttpUrl r12 = r1.url()     // Catch:{ AssertionError -> 0x00c1 }
            java.lang.String r12 = r12.host()     // Catch:{ AssertionError -> 0x00c1 }
            okhttp3.HttpUrl r13 = r1.url()     // Catch:{ AssertionError -> 0x00c1 }
            ...
            r6 = r0
            r0 = r16
            okhttp3.ConnectionSpec r3 = r0.configureSecureSocket(r6)     // Catch:{ AssertionError -> 0x00c1 }
            boolean r11 = r3.supportsTlsExtensions()     // Catch:{ AssertionError -> 0x00c1 }
            if (r11 == 0) goto L_0x0046
            okhttp3.internal.platform.Platform r11 = okhttp3.internal.platform.Platform.get()     // Catch:{ AssertionError -> 0x00c1 }
            okhttp3.HttpUrl r12 = r1.url()     // Catch:{ AssertionError -> 0x00c1 }
            java.lang.String r12 = r12.host()     // Catch:{ AssertionError -> 0x00c1 }
        ...
        L_0x0046:
            ...
            okhttp3.Handshake r10 = okhttp3.Handshake.get(r8)     // Catch:{ AssertionError -> 0x00c1 }
            ...
            java.lang.StringBuilder r12 = r12.append(r13)     // Catch:{ AssertionError -> 0x00c1 }
            java.lang.String r13 = okhttp3.CertificatePinner.pin(r2)     // Catch:{ AssertionError -> 0x00c1 }
            java.lang.StringBuilder r12 = r12.append(r13)     // Catch:{ AssertionError -> 0x00c1 }
            ...
            java.lang.String r13 = "\n    subjectAltNames: "
            java.lang.StringBuilder r12 = r12.append(r13)     // Catch:{ AssertionError -> 0x00c1 }
            java.util.List r13 = okhttp3.internal.tls.OkHostnameVerifier.allSubjectAltNames(r2)     // Catch:{ AssertionError -> 0x00c1 }
            java.lang.StringBuilder r12 = r12.append(r13)     // Catch:{ AssertionError -> 0x00c1 }
        ...
        L_0x00c1:
            r4 = move-exception
            boolean r11 = okhttp3.internal.Util.isAndroidGetsocknameError(r4)     // Catch:{ all -> 0x00ce }
        ...
        L_0x00dd:
            throw r11
        L_0x00de:
            okhttp3.CertificatePinner r11 = r1.certificatePinner()     // Catch:{ AssertionError -> 0x00c1 }
            okhttp3.HttpUrl r12 = r1.url()     // Catch:{ AssertionError -> 0x00c1 }
            java.lang.String r12 = r12.host()     // Catch:{ AssertionError -> 0x00c1 }
            java.util.List r13 = r10.peerCertificates()     // Catch:{ AssertionError -> 0x00c1 }
            r11.check((java.lang.String) r12, (java.util.List<java.security.cert.Certificate>) r13)     // Catch:{ AssertionError -> 0x00c1 }
            boolean r11 = r3.supportsTlsExtensions()     // Catch:{ AssertionError -> 0x00c1 }
        ...
        L_0x00ff:
            ...
            okio.Source r11 = okio.Okio.source((java.net.Socket) r11)     // Catch:{ AssertionError -> 0x00c1 }
            okio.BufferedSource r11 = okio.Okio.buffer((okio.Source) r11)     // Catch:{ AssertionError -> 0x00c1 }
            r15.source = r11     // Catch:{ AssertionError -> 0x00c1 }
            java.net.Socket r11 = r15.socket     // Catch:{ AssertionError -> 0x00c1 }
            okio.Sink r11 = okio.Okio.sink((java.net.Socket) r11)     // Catch:{ AssertionError -> 0x00c1 }
            okio.BufferedSink r11 = okio.Okio.buffer((okio.Sink) r11)     // Catch:{ AssertionError -> 0x00c1 }
            r15.sink = r11     // Catch:{ AssertionError -> 0x00c1 }
            r15.handshake = r10     // Catch:{ AssertionError -> 0x00c1 }
            if (r5 == 0) goto L_0x0135
            okhttp3.Protocol r11 = okhttp3.Protocol.get(r5)     // Catch:{ AssertionError -> 0x00c1 }
        L_0x0121:
        ...
        L_0x0133:
            ...
            goto L_0x00ff
        L_0x0135:
            okhttp3.Protocol r11 = okhttp3.Protocol.HTTP_1_1     // Catch:{ AssertionError -> 0x00c1 }
            goto L_0x0121
        L_0x0138:
    ...
    public String toString() {
        Object obj;
        StringBuilder append = new StringBuilder().append("Connection{").append(this.route.address().url().host()).append(SymbolExpUtil.SYMBOL_COLON).append(this.route.address().url().port()).append(", proxy=").append(this.route.proxy()).append(" hostAddress=").append(this.route.socketAddress()).append(" cipherSuite=");
