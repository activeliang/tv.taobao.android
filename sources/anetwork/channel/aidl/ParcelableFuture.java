...
public interface ParcelableFuture extends IInterface {
    ...
    public static abstract class Stub extends Binder implements ParcelableFuture {
        ...
        public static ParcelableFuture asInterface(IBinder obj) {
            if (obj == null) {
                return null;
            }
            IInterface iin = obj.queryLocalInterface(DESCRIPTOR);
            if (iin == null || !(iin instanceof ParcelableFuture)) {
                return new Proxy(obj);
            }
            return (ParcelableFuture) iin;
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 4:
                    data.enforceInterface(DESCRIPTOR);
                    NetworkResponse _result4 = get(data.readLong());
                    reply.writeNoException();
                    if (_result4 != null) {
                        reply.writeInt(1);
