...
public class ErrorConstant {
    ...
    static {
        mtopServerErrCodeMappingMap.put(ERRCODE_FAIL_SYS_API_STOP_SERVICE, MAPPING_CODE_FAIL_SYS_API_STOP_SERVICE);
        ...
        mtopServerErrCodeMappingMap.put(ERRCODE_FAIL_SYS_SESSION_EXPIRED, MAPPING_CODE_FAIL_SYS_SESSION_EXPIRED);
        ...
        mtopServerErrCodeMappingMap.put(ERRCODE_FAIL_SYS_FLOWLIMIT, MAPPING_CODE_FAIL_SYS_FLOWLIMIT);
        ...
        mtopServerErrCodeMappingMap.put(ERRCODE_FAIL_SYS_TRAFFIC_LIMIT, MAPPING_CODE_FAIL_SYS_TRAFFIC_LIMIT);
        ...
        mtopServerErrCodeMappingMap.put(ERRCODE_SYSTEM_ERROR, MAPPING_CODE_SYSTEM_ERROR);
        ...
        mtopServerErrCodeMappingMap.put(ERRCODE_FAIL_SYS_REQUEST_QUEUED, MAPPING_CODE_FAIL_SYS_REQUEST_QUEUED);
        mtopServerErrCodeMappingMap.put(ERRCODE_FAIL_SYS_SERVICE_NOT_EXIST, MAPPING_CODE_FAIL_SYS_SERVICE_NOT_EXIST);
        mtopServerErrCodeMappingMap.put(ERRCODE_FAIL_SYS_SERVICE_TIMEOUT, MAPPING_CODE_FAIL_SYS_SERVICE_TIMEOUT);
        mtopServerErrCodeMappingMap.put(ERRCODE_FAIL_SYS_SERVICE_FAULT, MAPPING_CODE_FAIL_SYS_SERVICE_FAULT);
        ...
        mtopServerErrCodeMappingMap.put(ERRCODE_FAIL_SYS_HTTP_RESPONSE_TIMEOUT, MAPPING_CODE_FAIL_SYS_HTTP_RESPONSE_TIMEOUT);
        mtopServerErrCodeMappingMap.put(ERRCODE_FAIL_SYS_HTTP_CONNECT_TIMEOUT, MAPPING_CODE_FAIL_SYS_HTTP_CONNECT_TIMEOUT);
        ...
        mtopServerErrCodeMappingMap.put(ERRCODE_FAIL_SYS_SERVICE_INNER_FAULT, MAPPING_CODE_FAIL_SYS_SERVICE_INNER_FAULT);
        mtopSdkErrCodeMappingMap.put(ERRCODE_NO_NETWORK, MAPPING_CODE_NO_NETWORK);
        mtopSdkErrCodeMappingMap.put(ERRCODE_NETWORK_ERROR, MAPPING_CODE_NETWORK_ERROR);
        ...
        mtopSdkErrCodeMappingMap.put(ERRCODE_API_FLOW_LIMIT_LOCKED, MAPPING_CODE_API_FLOW_LIMIT_LOCKED);
    ...
    @Deprecated
    public static Integer getMtopSdkIntErrCode(String key) {
        return -1000;
    }

    public static String getMappingCodeByErrorCode(String key) {
        return errCodeMappingMap.get(key);
    }

    public static boolean isSystemError(String key) {
        return mtopServerErrCodeMappingMap.containsKey(key);
    }

    public static boolean isMtopSdkError(String key) {
        return StringUtils.isBlank(key) || mtopSdkErrCodeMappingMap.containsKey(key);
    }

    public static boolean isNetworkError(String key) {
        return ERRCODE_NETWORK_ERROR.equals(key) || ERRCODE_NO_NETWORK.equals(key);
    }

    public static boolean isNoNetwork(String key) {
        return ERRCODE_NO_NETWORK.equals(key);
    }

    public static boolean isSessionInvalid(String key) {
        return ERRCODE_FAIL_SYS_SESSION_EXPIRED.equals(key) || ERRCODE_ANDROID_SYS_LOGIN_FAIL.equals(key);
    }

    public static boolean isIllegelSign(String key) {
        return ERRCODE_FAIL_SYS_ILEGEL_SIGN.equals(key);
    }
    ...
    public static boolean is41XResult(String key) {
        return ERRCODE_API_41X_ANTI_ATTACK.equals(key);
    }

    public static boolean isApiLockedResult(String key) {
        return ERRCODE_API_FLOW_LIMIT_LOCKED.equals(key);
    }

    public static boolean isExpiredRequest(String key) {
        return ERRCODE_FAIL_SYS_EXPIRED_REQUEST.equals(key) || ERRCODE_FAIL_SYS_REQUEST_EXPIRED.equals(key);
    }

    public static boolean isMtopServerError(String key) {
        return key != null && (mtopServerErrCodeMappingMap.containsKey(key) || key.startsWith(FAIL_SYS_PREFIX));
    }

    public static String appendMappingCode(int responseCode, String mappingCodeSuffix) {
        StringBuilder mappingCode = new StringBuilder();
        mappingCode.append(responseCode).append("A").append(mappingCodeSuffix);
