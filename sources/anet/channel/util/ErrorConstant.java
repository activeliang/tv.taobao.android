...
public class ErrorConstant {
    ...
    static {
        ...
        errorMsgMap.put(ERROR_NO_NETWORK, mtopsdk.mtop.util.ErrorConstant.ERRMSG_NO_NETWORK);
    ...
    public static String getErrMsg(int errorCode) {
        return StringUtils.stringNull2Empty(errorMsgMap.get(errorCode));
    }

    public static String formatMsg(int errorCode, String appendMsg) {
        return StringUtils.concatString(getErrMsg(errorCode), SymbolExpUtil.SYMBOL_COLON, appendMsg);
    }
}
