...
public class WebErrorView extends RelativeLayout {
    ...
    private void init(Context context) {
        ...
        RelativeLayout.LayoutParams lpTxt = new RelativeLayout.LayoutParams(-2, -2);
        lpTxt.addRule(14);
        lpTxt.addRule(3, 130);
        addView(txt, lpTxt);
    }
