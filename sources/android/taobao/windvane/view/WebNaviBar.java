...
public class WebNaviBar extends AbstractNaviBar {
    ...
    private Drawable[] drawableNext = new Drawable[2];
    private Drawable drawablePre = null;
    /* access modifiers changed from: private */
    public Drawable[] drawableRefresh = new Drawable[2];
    private ImageButton imgNext = null;
    private ImageButton imgPre = null;
    /* access modifiers changed from: private */
    public ImageButton imgRefresh = null;
    /* access modifiers changed from: private */
    public Context mContext = null;
    private int mHeight = 100;
    private Paint paint;
    private int sideMargin = 70;
    protected WebView webview;

    public WebNaviBar(Context context, AttributeSet attrs, int defStyle, WebView webview2) {
        super(context, attrs, defStyle);
        this.webview = webview2;
        init(context);
    }

    public WebNaviBar(Context context, AttributeSet attrs, WebView webview2) {
        super(context, attrs);
        this.webview = webview2;
        init(context);
    }

    public WebNaviBar(Context context, WebView webview2) {
        super(context);
        this.webview = webview2;
        init(context);
    }
    ...
    private void setNextIcon(Context context, Resources resources) {
        ...
        RelativeLayout.LayoutParams params = new RelativeLayout.LayoutParams(this.mHeight, this.mHeight - 2);
        params.addRule(15);
        params.addRule(5, 112);
        params.leftMargin = this.sideMargin * 2;
    ...
    private void setRefreshIcon(Context context, Resources resources) {
        ...
        params.addRule(15);
        params.addRule(11);
        params.rightMargin = this.sideMargin;
        ...
        addView(this.imgRefresh, params);
    }

    private void setClickListener(ImageButton imgBtn, final int index) {
