    ...
    public void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            if (!(child.getVisibility() == 8 || (lp2 = (LayoutParams) child.getLayoutParams()) == null || !lp2.isDecor)) {
                ...
                if (consumeVertical) {
                    widthMode = UCCore.VERIFY_POLICY_QUICK;
        ...
        this.mChildWidthMeasureSpec = View.MeasureSpec.makeMeasureSpec(childWidthSize, UCCore.VERIFY_POLICY_QUICK);
        this.mChildHeightMeasureSpec = View.MeasureSpec.makeMeasureSpec(childHeightSize, UCCore.VERIFY_POLICY_QUICK);
        this.mInLayout = true;
        populate();
        ...
        for (int i2 = 0; i2 < size2; i2++) {
            ...
            if (child2.getVisibility() != 8 && ((lp = (LayoutParams) child2.getLayoutParams()) == null || !lp.isDecor)) {
                child2.measure(View.MeasureSpec.makeMeasureSpec((int) (((float) childWidthSize) * lp.widthFactor), UCCore.VERIFY_POLICY_QUICK), this.mChildHeightMeasureSpec);
            }
        }
    }
            ...
            if (child2.getVisibility() != 8) {
                ...
                if (!lp2.isDecor && (ii = infoForChild(child2)) != null) {
                    ...
                    if (lp2.needsMeasure) {
                        ...
                        child2.measure(View.MeasureSpec.makeMeasureSpec((int) (((float) childWidth) * lp2.widthFactor), UCCore.VERIFY_POLICY_QUICK), View.MeasureSpec.makeMeasureSpec((height - paddingTop) - paddingBottom, UCCore.VERIFY_POLICY_QUICK));
                    }
