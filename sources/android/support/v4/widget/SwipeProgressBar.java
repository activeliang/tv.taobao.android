...
final class SwipeProgressBar {
    ...
    public void draw(Canvas canvas) {
        ...
        if (this.mRunning || this.mFinishTime > 0) {
            ...
            long elapsed = (now - this.mStartTime) % AbstractClientManager.BIND_SERVICE_TIMEOUT;
            long iterations = (now - this.mStartTime) / AbstractClientManager.BIND_SERVICE_TIMEOUT;
