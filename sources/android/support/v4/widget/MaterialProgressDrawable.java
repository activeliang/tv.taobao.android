    ...
    private static class Ring {
        ...
        private void drawTriangle(Canvas c, float startAngle, float sweepAngle, Rect bounds) {
            if (this.mShowArrow) {
                ...
                float x = (float) ((this.mRingCenterRadius * Math.cos(ClientTraceData.b.f47a)) + ((double) bounds.exactCenterX()));
                float y = (float) ((this.mRingCenterRadius * Math.sin(ClientTraceData.b.f47a)) + ((double) bounds.exactCenterY()));
        ...
        public void setInsets(int width, int height) {
            ...
            if (this.mRingCenterRadius <= ClientTraceData.b.f47a || minEdge < 0.0f) {
