...
public class SwipeRefreshLayout extends ViewGroup implements NestedScrollingParent, NestedScrollingChild {
    ...
    public void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (this.mTarget != null) {
            ...
            this.mCircleView.measure(View.MeasureSpec.makeMeasureSpec(this.mCircleDiameter, UCCore.VERIFY_POLICY_QUICK), View.MeasureSpec.makeMeasureSpec(this.mCircleDiameter, UCCore.VERIFY_POLICY_QUICK));
            this.mCircleViewIndex = -1;
    ...
    private void moveSpinner(float overscrollTop) {
        ...
        float adjustedPercent = (((float) Math.max(((double) dragPercent) - 0.4d, ClientTraceData.b.f47a)) * 5.0f) / 3.0f;
