                ...
                if (child3.getVisibility() != 8) {
                    ...
                    if (childExtra > 0.0f) {
                        ...
                        if (lp3.height == 0 && heightMode == 1073741824) {
                            ...
                            child3.measure(childWidthMeasureSpec, View.MeasureSpec.makeMeasureSpec(share, UCCore.VERIFY_POLICY_QUICK));
                        } else {
                            int childHeight2 = child3.getMeasuredHeight() + share;
                            if (childHeight2 < 0) {
                                childHeight2 = 0;
                            }
                            child3.measure(childWidthMeasureSpec, View.MeasureSpec.makeMeasureSpec(childHeight2, UCCore.VERIFY_POLICY_QUICK));
                        }
            ...
            if (useLargestChild && heightMode != 1073741824) {
                for (int i4 = 0; i4 < count; i4++) {
                    ...
                    if (!(child4 == null || child4.getVisibility() == 8 || ((LayoutParams) child4.getLayoutParams()).weight <= 0.0f)) {
                        child4.measure(View.MeasureSpec.makeMeasureSpec(child4.getMeasuredWidth(), UCCore.VERIFY_POLICY_QUICK), View.MeasureSpec.makeMeasureSpec(largestChildHeight, UCCore.VERIFY_POLICY_QUICK));
                    }
                }
            }
        }
        ...
        if (skippedMeasure || (delta != 0 && totalWeight > 0.0f)) {
                ...
                if (!(child3 == null || child3.getVisibility() == 8)) {
                    ...
                    if (childExtra > 0.0f) {
                        ...
                        if (lp3.width == 0 && widthMode == 1073741824) {
                            ...
                            child3.measure(View.MeasureSpec.makeMeasureSpec(share, UCCore.VERIFY_POLICY_QUICK), childHeightMeasureSpec);
                        } else {
                            int childWidth2 = child3.getMeasuredWidth() + share;
                            if (childWidth2 < 0) {
                                childWidth2 = 0;
                            }
                            child3.measure(View.MeasureSpec.makeMeasureSpec(childWidth2, UCCore.VERIFY_POLICY_QUICK), childHeightMeasureSpec);
                        }
            ...
            if (useLargestChild && widthMode != 1073741824) {
                for (int i6 = 0; i6 < count; i6++) {
                    ...
                    if (!(child4 == null || child4.getVisibility() == 8 || ((LayoutParams) child4.getLayoutParams()).weight <= 0.0f)) {
                        child4.measure(View.MeasureSpec.makeMeasureSpec(largestChildWidth, UCCore.VERIFY_POLICY_QUICK), View.MeasureSpec.makeMeasureSpec(child4.getMeasuredHeight(), UCCore.VERIFY_POLICY_QUICK));
                    }
                }
            }
        }
