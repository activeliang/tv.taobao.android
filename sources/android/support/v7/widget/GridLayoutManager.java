    ...
    public void layoutChunk(RecyclerView.Recycler recycler, RecyclerView.State state, LinearLayoutManager.LayoutState layoutState, LinearLayoutManager.LayoutChunkResult result) {
        ...
        if (flexibleInOtherDir) {
            ...
            for (int i2 = 0; i2 < count; i2++) {
                ...
                measureChild(view3, UCCore.VERIFY_POLICY_QUICK, true);
        ...
        for (int i3 = 0; i3 < count; i3++) {
            ...
            if (this.mOrientationHelper.getDecoratedMeasurement(view4) != maxSize) {
                ...
                if (this.mOrientation == 1) {
                    wSpec = getChildMeasureSpec(totalSpaceInOther, UCCore.VERIFY_POLICY_QUICK, horizontalInsets, lp.width, false);
                    hSpec = View.MeasureSpec.makeMeasureSpec(maxSize - verticalInsets, UCCore.VERIFY_POLICY_QUICK);
                } else {
                    wSpec = View.MeasureSpec.makeMeasureSpec(maxSize - horizontalInsets, UCCore.VERIFY_POLICY_QUICK);
                    hSpec = getChildMeasureSpec(totalSpaceInOther, UCCore.VERIFY_POLICY_QUICK, verticalInsets, lp.height, false);
                }
