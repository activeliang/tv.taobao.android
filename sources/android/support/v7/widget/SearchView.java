...
public class SearchView extends LinearLayoutCompat implements CollapsibleActionView {
    ...
    public void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        super.onMeasure(View.MeasureSpec.makeMeasureSpec(width, UCCore.VERIFY_POLICY_QUICK), View.MeasureSpec.makeMeasureSpec(height, UCCore.VERIFY_POLICY_QUICK));
    }
    ...
    private Intent createVoiceAppSearchIntent(Intent baseIntent, SearchableInfo searchable) {
        ...
        PendingIntent pending = PendingIntent.getActivity(getContext(), 0, queryIntent, UCCore.VERIFY_POLICY_QUICK);
    ...
    private Intent createIntentFromSuggestion(Cursor c, int actionKey, String actionMsg) {
        ...
        try {
            ...
            if (!(data == null || (id = SuggestionsAdapter.getColumnString(c, "suggest_intent_data_id")) == null)) {
                data = data + WVNativeCallbackUtil.SEPERATER + Uri.encode(id);
            }
