...
public class ScrollingTabContainerView extends HorizontalScrollView implements AdapterView.OnItemSelectedListener {
    ...
    public void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        int heightMeasureSpec2 = View.MeasureSpec.makeMeasureSpec(this.mContentHeight, UCCore.VERIFY_POLICY_QUICK);
    ...
    private class TabView extends LinearLayoutCompat implements View.OnLongClickListener {
        ...
        public void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
            ...
            if (ScrollingTabContainerView.this.mMaxTabWidth > 0 && getMeasuredWidth() > ScrollingTabContainerView.this.mMaxTabWidth) {
                super.onMeasure(View.MeasureSpec.makeMeasureSpec(ScrollingTabContainerView.this.mMaxTabWidth, UCCore.VERIFY_POLICY_QUICK), heightMeasureSpec);
            }
        }
