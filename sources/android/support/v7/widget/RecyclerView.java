        ...
        if (this.mLayout == null) {
            ...
            if (!skipMeasure && this.mAdapter != null) {
                ...
                if (this.mLayout.shouldMeasureTwice()) {
                    this.mLayout.setMeasureSpecs(View.MeasureSpec.makeMeasureSpec(getMeasuredWidth(), UCCore.VERIFY_POLICY_QUICK), View.MeasureSpec.makeMeasureSpec(getMeasuredHeight(), UCCore.VERIFY_POLICY_QUICK));
                    this.mState.mIsMeasuring = true;
                    dispatchLayoutStep2();
                    this.mLayout.setMeasuredDimensionFromChildren(widthSpec, heightSpec);
                }
        ...
        public static int getChildMeasureSpec(int parentSize, int padding, int childDimension, boolean canScroll) {
            ...
            if (canScroll) {
                if (childDimension >= 0) {
                    ...
                    resultMode = UCCore.VERIFY_POLICY_QUICK;
                } else {
                    resultSize = 0;
                    resultMode = 0;
                }
