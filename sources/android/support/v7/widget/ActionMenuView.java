...
public class ActionMenuView extends LinearLayoutCompat implements MenuBuilder.ItemInvoker, MenuView {
    ...
    private void onMeasureExactFormat(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (needsExpansion) {
            for (int i5 = 0; i5 < childCount; i5++) {
                ...
                if (lp5.expanded) {
                    child4.measure(View.MeasureSpec.makeMeasureSpec((lp5.cellsUsed * cellSize) + lp5.extraPixels, UCCore.VERIFY_POLICY_QUICK), itemHeightSpec);
                }
            }
        }
    ...
    static int measureChildForCells(View child, int cellSize, int cellsRemaining, int parentHeightMeasureSpec, int parentHeightPadding) {
        ...
        child.measure(View.MeasureSpec.makeMeasureSpec(cellsUsed * cellSize, UCCore.VERIFY_POLICY_QUICK), childHeightSpec);
        return cellsUsed;
    }
