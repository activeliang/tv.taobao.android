    ...
    public void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (View.MeasureSpec.getMode(widthMeasureSpec) != 1073741824) {
            ...
            if (this.mCustomView != null) {
                ...
                int customWidthMode = lp2.width != -2 ? UCCore.VERIFY_POLICY_QUICK : Integer.MIN_VALUE;
                if (lp2.width >= 0) {
                    customWidth = Math.min(lp2.width, availableWidth);
                } else {
                    customWidth = availableWidth;
                }
                int customHeightMode = lp2.height != -2 ? UCCore.VERIFY_POLICY_QUICK : Integer.MIN_VALUE;
                if (lp2.height >= 0) {
