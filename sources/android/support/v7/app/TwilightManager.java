...
class TwilightManager {
    ...
    private void updateState(@NonNull Location location) {
        ...
        calculator.calculateTwilight(now - ZipAppConstants.UPDATEGROUPID_AGE, location.getLatitude(), location.getLongitude());
        ...
        calculator.calculateTwilight(ZipAppConstants.UPDATEGROUPID_AGE + now, location.getLatitude(), location.getLongitude());
