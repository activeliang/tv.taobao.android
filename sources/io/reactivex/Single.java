...
public abstract class Single<T> implements SingleSource<T> {
    ...
    public static <T> Single<T> amb(Iterable<? extends SingleSource<? extends T>> sources) {
        ...
        return RxJavaPlugins.onAssembly(new SingleAmb((SingleSource<? extends T>[]) null, sources));
    }
    ...
    public static <T> Single<T> ambArray(SingleSource<? extends T>... sources) {
        ...
        return RxJavaPlugins.onAssembly(new SingleAmb(sources, (Iterable) null));
    }
    ...
    public final Flowable<T> concatWith(SingleSource<? extends T> other) {
        return concat(this, (Single) other);
    }
    ...
    public final Single<T> onErrorReturnItem(T value) {
        ObjectHelper.requireNonNull(value, "value is null");
        return RxJavaPlugins.onAssembly(new SingleOnErrorReturn(this, (Function) null, value));
    }
    ...
    public final Single<T> timeout(long timeout, TimeUnit unit) {
        return timeout0(timeout, unit, Schedulers.computation(), (SingleSource) null);
    }

    @CheckReturnValue
    @SchedulerSupport("custom")
    public final Single<T> timeout(long timeout, TimeUnit unit, Scheduler scheduler) {
        return timeout0(timeout, unit, scheduler, (SingleSource) null);
    }
