...
public final class BehaviorSubject<T> extends Subject<T> {
    ...
    public BehaviorDisposable<T>[] terminate(Object terminalValue) {
        ...
        if (!(a == TERMINATED || (a = (BehaviorDisposable[]) this.subscribers.getAndSet(TERMINATED)) == TERMINATED)) {
    ...
    static final class BehaviorDisposable<T> implements Disposable, AppendOnlyLinkedArrayList.NonThrowingPredicate<Object> {
        ...
        BehaviorDisposable(Observer<? super T> actual2, BehaviorSubject<T> state2) {
            this.actual = actual2;
            this.state = state2;
        }
