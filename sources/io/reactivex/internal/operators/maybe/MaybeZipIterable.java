...
public final class MaybeZipIterable<T, R> extends Maybe<R> {
    ...
    public void subscribeActual(io.reactivex.MaybeObserver<? super R> r12) {
        ...
        L_0x000c:
            ...
            io.reactivex.internal.disposables.EmptyDisposable.error((java.lang.Throwable) r8, (io.reactivex.MaybeObserver<?>) r12)     // Catch:{ Throwable -> 0x0082 }
            r4 = r5
        L_0x0026:
            return
        L_0x0027:
        ...
        L_0x003c:
            ...
            io.reactivex.internal.disposables.EmptyDisposable.error((java.lang.Throwable) r2, (io.reactivex.MaybeObserver<?>) r12)
            goto L_0x0026
        L_0x0043:
            if (r5 != 0) goto L_0x004a
            io.reactivex.internal.disposables.EmptyDisposable.complete((io.reactivex.MaybeObserver<?>) r12)
            r4 = r5
            goto L_0x0026
        L_0x004a:
            r8 = 1
