...
public final class FlowableCombineLatest<T, R> extends Flowable<R> {
    ...
    public FlowableCombineLatest(@NonNull Publisher<? extends T>[] array2, @NonNull Function<? super Object[], ? extends R> combiner2, int bufferSize2, boolean delayErrors2) {
        this.array = array2;
        this.iterable = null;
    ...
    public FlowableCombineLatest(@NonNull Iterable<? extends Publisher<? extends T>> iterable2, @NonNull Function<? super Object[], ? extends R> combiner2, int bufferSize2, boolean delayErrors2) {
        this.array = null;
    ...
    static final class CombineLatestCoordinator<T, R> extends BasicIntQueueSubscription<R> {
        ...
        CombineLatestCoordinator(Subscriber<? super R> actual2, Function<? super Object[], ? extends R> combiner2, int n, int bufferSize, boolean delayErrors2) {
            this.actual = actual2;
            this.combiner = combiner2;
