...
public final class FlowableWindowBoundarySupplier<T, B> extends AbstractFlowableWithUpstream<T, Flowable<T>> {
    ...
    public FlowableWindowBoundarySupplier(Flowable<T> source, Callable<? extends Publisher<B>> other2, int bufferSize2) {
        super(source);
        this.other = other2;
    ...
    static final class WindowBoundaryMainSubscriber<T, B> extends QueueDrainSubscriber<T, Object, Flowable<T>> implements Subscription {
        ...
        WindowBoundaryMainSubscriber(Subscriber<? super Flowable<T>> actual, Callable<? extends Publisher<B>> other2, int bufferSize2) {
                ...
                if (!this.cancelled) {
                    try {
                        ...
                        if (r != 0) {
                            ...
                            if (this.boundary.compareAndSet((Object) null, inner)) {
