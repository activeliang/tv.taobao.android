...
public final class CompletableTimeout extends Completable {
    ...
    static final class TimeOutObserver implements CompletableObserver {
        ...
        TimeOutObserver(CompositeDisposable set2, AtomicBoolean once2, CompletableObserver s2) {
            this.set = set2;
            this.once = once2;
            this.s = s2;
        }
    ...
    final class DisposeTask implements Runnable {
        ...
        DisposeTask(AtomicBoolean once2, CompositeDisposable set2, CompletableObserver s2) {
            this.once = once2;
            this.set = set2;
            this.s = s2;
        }
