    ...
    static final class ReplaySource<T> implements ObservableSource<T> {
        ...
        public void subscribe(io.reactivex.Observer<? super T> r7) {
            /*
                r6 = this;
            L_0x0000:
                java.util.concurrent.atomic.AtomicReference<io.reactivex.internal.operators.observable.ObservableReplay$ReplayObserver<T>> r4 = r6.curr
                java.lang.Object r2 = r4.get()
                io.reactivex.internal.operators.observable.ObservableReplay$ReplayObserver r2 = (io.reactivex.internal.operators.observable.ObservableReplay.ReplayObserver) r2
                if (r2 != 0) goto L_0x001f
                io.reactivex.internal.operators.observable.ObservableReplay$BufferSupplier<T> r4 = r6.bufferFactory
                io.reactivex.internal.operators.observable.ObservableReplay$ReplayBuffer r0 = r4.call()
                io.reactivex.internal.operators.observable.ObservableReplay$ReplayObserver r3 = new io.reactivex.internal.operators.observable.ObservableReplay$ReplayObserver
                r3.<init>(r0)
                java.util.concurrent.atomic.AtomicReference<io.reactivex.internal.operators.observable.ObservableReplay$ReplayObserver<T>> r4 = r6.curr
                r5 = 0
            ...
            L_0x0033:
                return
            L_0x0034:
                io.reactivex.internal.operators.observable.ObservableReplay$ReplayBuffer<T> r4 = r2.buffer
                r4.replay(r1)
                goto L_0x0033
            */
