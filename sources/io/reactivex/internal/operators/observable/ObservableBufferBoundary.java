...
public final class ObservableBufferBoundary<T, U extends Collection<? super T>, Open, Close> extends AbstractObservableWithUpstream<T, U> {
    ...
    static final class BufferBoundaryObserver<T, C extends Collection<? super T>, Open, Close> extends AtomicInteger implements Observer<T>, Disposable {
        ...
        public void close(io.reactivex.internal.operators.observable.ObservableBufferBoundary.BufferCloseObserver<T, C> r7, long r8) {
            /*
                r6 = this;
                io.reactivex.disposables.CompositeDisposable r2 = r6.observers
                r2.delete(r7)
                r1 = 0
                io.reactivex.disposables.CompositeDisposable r2 = r6.observers
                int r2 = r2.size()
                ...
                r1 = 1
                java.util.concurrent.atomic.AtomicReference<io.reactivex.disposables.Disposable> r2 = r6.upstream
