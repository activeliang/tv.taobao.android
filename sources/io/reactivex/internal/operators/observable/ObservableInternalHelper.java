...
public final class ObservableInternalHelper {
    ...
    /* JADX WARNING: type inference failed for: r3v0, types: [io.reactivex.functions.Function, io.reactivex.functions.Function<? super T, ? extends io.reactivex.SingleSource<? extends R>>] */
    /* JADX WARNING: Unknown variable types count: 1 */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public static <T, R> io.reactivex.Observable<R> switchMapSingle(io.reactivex.Observable<T> r2, io.reactivex.functions.Function<? super T, ? extends io.reactivex.SingleSource<? extends R>> r3) {
        /*
            io.reactivex.functions.Function r0 = convertSingleMapperToObservableMapper(r3)
            r1 = 1
            io.reactivex.Observable r0 = r2.switchMap(r0, r1)
            return r0
        */
    ...
    /* JADX WARNING: Unknown variable types count: 1 */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public static <T, R> io.reactivex.Observable<R> switchMapSingleDelayError(io.reactivex.Observable<T> r2, io.reactivex.functions.Function<? super T, ? extends io.reactivex.SingleSource<? extends R>> r3) {
        /*
            io.reactivex.functions.Function r0 = convertSingleMapperToObservableMapper(r3)
            r1 = 1
            io.reactivex.Observable r0 = r2.switchMapDelayError(r0, r1)
            return r0
        */
    ...
    static final class ObservableMapper<T, R> implements Function<T, Observable<R>> {
        ...
        ObservableMapper(Function<? super T, ? extends SingleSource<? extends R>> mapper2) {
            this.mapper = mapper2;
        }
