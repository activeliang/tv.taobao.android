...
public class DialogFocusLeftRightPositionManager extends FocusPositionManager {
    ...
    public DialogFocusLeftRightPositionManager(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
    }

    public DialogFocusLeftRightPositionManager(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public DialogFocusLeftRightPositionManager(Context context) {
        super(context);
    }
    ...
    private void changeBtnSelectStatus() {
        if (this.mPositiveButton != null && this.mNegativeButton != null) {
            if (this.mCurSelect == CUR_SELECT.POSITIVE_BTN) {
                ...
                this.mPositiveButton.setBackgroundResource(R.drawable.gradient_dialog_right_focus);
            ...
            this.mNegativeButton.setBackgroundResource(R.drawable.gradient_dialog_left_focus);
        }
    }
}
