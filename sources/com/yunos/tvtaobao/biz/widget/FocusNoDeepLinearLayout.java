...
public class FocusNoDeepLinearLayout extends LinearLayout implements FocusListener, ItemListener {
    ...
    public FocusNoDeepLinearLayout(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
    }

    public FocusNoDeepLinearLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public FocusNoDeepLinearLayout(Context context) {
        super(context);
    }
