...
public class ItemMO implements Serializable {
    ...
    public String toString() {
        return "ItemMO [itemId=" + this.itemId + ", juId=" + this.juId + ", longName=" + this.longName + ", shortName=" + this.shortName + ", itemUrl=" + this.itemUrl + ", itemCount=" + this.itemCount + ", parentCategory=" + this.parentCategory + ", childCategory=" + this.childCategory + ", shopType=" + this.shopType + ", payPostage=" + this.payPostage + ", originalPrice=" + this.originalPrice + ", picUrl=" + this.picUrl + ", picWideUrl=" + this.picWideUrl + ", picWideBytes=" + Arrays.toString(this.picWideBytes) + ", videoUrl=" + this.videoUrl + ", activityPrice=" + this.activityPrice + ", city=" + this.city + ", itemStatus=" + this.itemStatus + ", itemGuarantee=" + this.itemGuarantee + ", discount=" + this.discount + ", checkComment=" + this.checkComment + ", platformId=" + this.platformId + ", groupId=" + this.groupId + ", sellerId=" + this.sellerId + ", sellerNick=" + this.sellerNick + ", sellerCredit=" + this.sellerCredit + ", categoryId=" + this.categoryId + ", soldCount=" + this.soldCount + ", gmtCreate=" + this.gmtCreate + ", gmtModified=" + this.gmtModified + ", limitNum=" + this.limitNum + ", isLock=" + this.isLock + ", onlineStartTime=" + this.onlineStartTime + ", onlineEndTime=" + this.onlineEndTime + ", key=" + this.key + ", imageLabel=" + this.imageLabel + ", preOnline=" + this.preOnline + ", pushName=" + this.pushName + ", attributes=" + this.attributes + ", itemDesc=" + this.itemDesc + "]";
    }
    ...
    public void setPicFullUrl(String picFullUrl2) {
        this.picFullUrl = picFullUrl2;
    }
    ...
    public static ItemMO fromMTOP(JSONObject obj) throws JSONException {
        ...
        try {
            ...
            try {
                item.setJuId(Long.valueOf(obj.optLong("juId")));
                ...
                String[] strArr = {"http://cloud.video.taobao.com/play/u/916927465/p/1/e/2/t/1/d//fv/10520505.m3u8", "http://chyd-alivod.wasu.tv/data9/ott/344/2013-08/05/1375688697845_881704.m3u8", "http://chyd-alivod.wasu.tv/data9/ott/344/2013-08/05/1375688681871_994786.m3u8", "http://chyd-alivod.wasu.tv/data9/ott/344/2013-08/05/1375688609065_225617.m3u8", "http://chyd-alivod.wasu.tv/data9/ott/344/2013-03/19/1363645123127_454344.m3u8", "http://chyd-alivod.wasu.tv/data9/ott/344/2013-04/28/1367131771833_320555.m3u8", "http://chyd-alivod.wasu.tv/data9/ott/344/2013-08/05/1375681540365_129665.m3u8", "http://chyd-alivod.wasu.tv/data9/ott/344/2013-08/05/1375681528463_594388.m3u8", "http://chyd-alivod.wasu.tv/data9/ott/344/2013-08/05/1375681450431_295144.m3u8", "http://chyd-alivod.wasu.tv/data9/ott/344/2013-03/15/1363318048722_914408.m3u8", "http://chyd-alivod.wasu.tv/data8/ott/340/2012-12/06/1354785613310_815508.m3u8", "http://chyd-alivod.wasu.tv/data8/ott/344/2012-12/06/1354785613231_972457.m3u8", "http://chyd-alivod.wasu.tv/data7/ott1/340/2012-11/27/1354008293948_502287.m3u8", "http://chyd-alivod.wasu.tv/data9/ott/344/2013-04/19/1366348611883_909390.m3u8", "http://chyd-alivod.wasu.tv/data8/ott/340/2012-12/05/1354701577528_867977.m3u8", "http://chyd-alivod.wasu.tv/data9/ott/344/2013-03/15/1363342317891_459789.m3u8", "http://chyd-alivod.wasu.tv/data8/ott/340/2012-12/28/1356686366242_874419.m3u8", "http://chyd-alivod.wasu.tv/data9/ott/344/2013-03/12/1363064081441_267119.m3u8"};
    ...
    public void setJuId(Long juId2) {
        this.juId = juId2;
    }
}
