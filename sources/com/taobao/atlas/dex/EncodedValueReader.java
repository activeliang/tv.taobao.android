...
public final class EncodedValueReader {
    ...
    public EncodedValueReader(ByteInput in2) {
        this.type = -1;
        this.in = in2;
    }

    public EncodedValueReader(EncodedValue in2) {
        this(in2.asByteInput());
    }

    public EncodedValueReader(ByteInput in2, int knownType) {
        this.type = -1;
        this.in = in2;
        this.type = knownType;
    }

    public EncodedValueReader(EncodedValue in2, int knownType) {
        this(in2.asByteInput(), knownType);
    }
