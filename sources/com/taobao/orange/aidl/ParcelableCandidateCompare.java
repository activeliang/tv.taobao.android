...
public interface ParcelableCandidateCompare extends IInterface {
    ...
    public static abstract class Stub extends Binder implements ParcelableCandidateCompare {
        ...
        public static ParcelableCandidateCompare asInterface(IBinder obj) {
            if (obj == null) {
                return null;
            }
            IInterface iin = obj.queryLocalInterface(DESCRIPTOR);
            if (iin == null || !(iin instanceof ParcelableCandidateCompare)) {
                return new Proxy(obj);
            }
            return (ParcelableCandidateCompare) iin;
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                case 1:
                    ...
                    boolean _result = equals(data.readString(), data.readString());
                ...
                case 2:
                    data.enforceInterface(DESCRIPTOR);
                    boolean _result2 = equalsNot(data.readString(), data.readString());
                    reply.writeNoException();
                    if (_result2) {
                        i = 1;
                    }
                ...
                case 3:
                    data.enforceInterface(DESCRIPTOR);
                    boolean _result3 = greater(data.readString(), data.readString());
                    reply.writeNoException();
                    if (_result3) {
                        i = 1;
                    }
                ...
                case 4:
                    data.enforceInterface(DESCRIPTOR);
                    boolean _result4 = greaterEquals(data.readString(), data.readString());
                    reply.writeNoException();
                    if (_result4) {
                        i = 1;
                    }
                ...
                case 5:
                    data.enforceInterface(DESCRIPTOR);
                    boolean _result5 = less(data.readString(), data.readString());
                    reply.writeNoException();
                    if (_result5) {
                        i = 1;
                    }
                ...
                case 6:
                    data.enforceInterface(DESCRIPTOR);
                    boolean _result6 = lessEquals(data.readString(), data.readString());
                    reply.writeNoException();
                    if (_result6) {
                        i = 1;
                    }
                ...
                case 7:
                    data.enforceInterface(DESCRIPTOR);
                    boolean _result7 = fuzzy(data.readString(), data.readString());
                    reply.writeNoException();
                    if (_result7) {
                        i = 1;
                    }
                ...
                case 8:
                    data.enforceInterface(DESCRIPTOR);
                    boolean _result8 = fuzzyNot(data.readString(), data.readString());
                    reply.writeNoException();
                    if (_result8) {
                        i = 1;
                    }
