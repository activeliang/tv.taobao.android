...
public abstract class TradeUpdateCartSkuListener extends AbstractCartRemoteBaseListener {
    public abstract void onSuccessExt(int i, MtopResponse mtopResponse, BaseOutDo baseOutDo, Object obj);

    public TradeUpdateCartSkuListener(CartFrom cartFrom) {
        super(cartFrom);
    }
    ...
    public void onSuccess(int requestType, MtopResponse response, BaseOutDo pojo, Object context) {
        ...
        if (!(pojo == null || !(pojo instanceof MtopTradeUpdateCartSkuResponse) || (data = ((MtopTradeUpdateCartSkuResponse) pojo).getData()) == null)) {
