...
public abstract class TradeUpdateBagCountListener extends AbstractCartRemoteBaseListener {
    public abstract void onSuccessExt(int i, MtopResponse mtopResponse, BaseOutDo baseOutDo, Object obj);

    public TradeUpdateBagCountListener(CartFrom cartFrom) {
        super(cartFrom);
    }
    ...
    public void onSuccess(int requestType, MtopResponse response, BaseOutDo pojo, Object context) {
        ...
        if (!(pojo == null || !(pojo instanceof MtopTradeUpdateBagCountResponse) || (data = ((MtopTradeUpdateBagCountResponse) pojo).getData()) == null)) {
