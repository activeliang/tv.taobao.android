...
public final class w {
    ...
    public static byte[] a(int i) {
        ...
        int i2 = ((bArr[0] & OnReminderListener.RET_FULL) * 256) + (bArr[1] & OnReminderListener.RET_FULL);
        int i3 = (bArr[3] & OnReminderListener.RET_FULL) + ((bArr[2] & OnReminderListener.RET_FULL) * 256);
