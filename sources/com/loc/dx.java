...
public final class dx implements SensorEventListener {
    ...
    double i = ClientTraceData.b.f47a;
    double j = ClientTraceData.b.f47a;
    double k = ClientTraceData.b.f47a;
    double l = ClientTraceData.b.f47a;
    double[] m = new double[3];
    volatile double n = ClientTraceData.b.f47a;
    long o = 0;
    long p = 0;
    final int q = 100;
    final int r = 30;
                    ...
                    case 6:
                        try {
                            if (this.b != null) {
                                ...
                                if (fArr3 != null) {
                                    this.f = (double) et.a(SensorManager.getAltitude(this.t, fArr3[0]));
                                    return;
                                }
                                return;
                            }
