...
public class Focus3Util {
    ...
    public static View getFinalFocusedView(View from) {
        View rtn = null;
        if (from instanceof ViewGroup) {
            for (View tmp = ((ViewGroup) from).getFocusedChild(); tmp != null; tmp = ((ViewGroup) tmp).getFocusedChild()) {
                rtn = tmp;
