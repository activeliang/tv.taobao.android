    ...
    public void write(JSONSerializer serializer, Object object, Object fieldName, Type fieldType, int features) throws IOException {
        ...
        if (out.isEnabled(SerializerFeature.UseISO8601DateFormat)) {
            ...
            if (timeZone == 0) {
                ...
                out.append((CharSequence) "+").append((CharSequence) String.format("%02d", new Object[]{Integer.valueOf(timeZone)})).append((CharSequence) ":00");
            } else {
                out.append((CharSequence) "-").append((CharSequence) String.format("%02d", new Object[]{Integer.valueOf(-timeZone)})).append((CharSequence) ":00");
            }
            out.append(quote);
        ...
        serializer.write((Object) calendar.getTime());
    }

    public <T> T deserialze(DefaultJSONParser parser, Type type, Object fieldName) {
        T deserialze = DateCodec.instance.deserialze(parser, type, fieldName);
