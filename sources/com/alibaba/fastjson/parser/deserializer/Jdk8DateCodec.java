    ...
    public <T> T deserialze(DefaultJSONParser parser, Type type, Object fieldName, String format, int feature) {
        ...
        if (lexer.token() == 4) {
            ...
            if (type == LocalDateTime.class) {
                ...
                return LocalDate.of(localDateTime2.getYear(), localDateTime2.getMonthValue(), localDateTime2.getDayOfMonth());
            } else if (type == LocalTime.class) {
                if (text.length() != 23) {
                    return LocalTime.parse(text);
                }
                LocalDateTime localDateTime3 = LocalDateTime.parse(text);
                return LocalTime.of(localDateTime3.getHour(), localDateTime3.getMinute(), localDateTime3.getSecond(), localDateTime3.getNano());
