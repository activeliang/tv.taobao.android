...
public class MessageUtils {
    ...
    public static com.ali.auth.third.core.message.Message createMessage(int r5, java.lang.Object... r6) {
        /*
            ...
            java.util.Map<java.lang.Integer, com.ali.auth.third.core.message.Message> r3 = cachedMessageMetas     // Catch:{ Exception -> 0x0065 }
            ...
            com.ali.auth.third.core.message.Message r1 = (com.ali.auth.third.core.message.Message) r1     // Catch:{ Exception -> 0x0065 }
            ...
            r3.lock()     // Catch:{ Exception -> 0x0065 }
            com.ali.auth.third.core.message.Message r1 = loadMessage(r5)     // Catch:{ all -> 0x005a }
            if (r1 == 0) goto L_0x0038
            java.util.Map<java.lang.Integer, com.ali.auth.third.core.message.Message> r3 = cachedMessageMetas     // Catch:{ all -> 0x005a }
        ...
        L_0x004a:
            ...
            com.ali.auth.third.core.message.Message r1 = createMessageNotFoundMessage(r5)     // Catch:{ all -> 0x0095 }
            java.util.concurrent.locks.ReentrantReadWriteLock r3 = lock     // Catch:{ Exception -> 0x0065 }
            java.util.concurrent.locks.ReentrantReadWriteLock$ReadLock r3 = r3.readLock()     // Catch:{ Exception -> 0x0065 }
            r3.unlock()     // Catch:{ Exception -> 0x0065 }
        L_0x0059:
        ...
        L_0x0065:
            ...
            com.ali.auth.third.core.message.Message r1 = createUnknownErrorMessage(r3)
            goto L_0x0059
        L_0x006f:
        ...
        L_0x007c:
            ...
            com.ali.auth.third.core.message.Message r2 = (com.ali.auth.third.core.message.Message) r2     // Catch:{ all -> 0x0095 }
        ...
        L_0x0095:
            ...
            throw r3     // Catch:{ Exception -> 0x0065 }
        */
        throw new UnsupportedOperationException("Method not decompiled: com.ali.auth.third.core.message.MessageUtils.createMessage(int, java.lang.Object[]):com.ali.auth.third.core.message.Message");
    }
    ...
    public static java.lang.String getMessageContent(int r4, java.lang.Object... r5) {
        /*
            ...
            java.util.Map<java.lang.Integer, com.ali.auth.third.core.message.Message> r2 = cachedMessageMetas     // Catch:{ Exception -> 0x0067 }
            ...
            com.ali.auth.third.core.message.Message r1 = (com.ali.auth.third.core.message.Message) r1     // Catch:{ Exception -> 0x0067 }
            if (r1 != 0) goto L_0x004a
            java.util.concurrent.locks.ReentrantReadWriteLock r2 = lock     // Catch:{ Exception -> 0x0067 }
            java.util.concurrent.locks.ReentrantReadWriteLock$ReadLock r2 = r2.readLock()     // Catch:{ Exception -> 0x0067 }
            ...
            r2.lock()     // Catch:{ Exception -> 0x0067 }
            com.ali.auth.third.core.message.Message r1 = loadMessage(r4)     // Catch:{ all -> 0x005c }
            if (r1 == 0) goto L_0x0038
            java.util.Map<java.lang.Integer, com.ali.auth.third.core.message.Message> r2 = cachedMessageMetas     // Catch:{ all -> 0x005c }
        ...
        L_0x004a:
            ...
            com.ali.auth.third.core.message.Message r2 = createMessageNotFoundMessage(r4)     // Catch:{ all -> 0x0083 }
        ...
        L_0x0067:
            ...
            com.ali.auth.third.core.message.Message r2 = createUnknownErrorMessage(r2)
        ...
        L_0x0083:
            ...
            throw r2     // Catch:{ Exception -> 0x0067 }
        */
        throw new UnsupportedOperationException("Method not decompiled: com.ali.auth.third.core.message.MessageUtils.getMessageContent(int, java.lang.Object[]):java.lang.String");
    }
