...
public class CookieManagerWrapper {
    ...
    public synchronized void refreshCookie() {
        ...
        if (this.mCookies != null) {
            injectCookie(this.mCookies, (String[]) null);
        }
    }

    public synchronized void injectCookie(String[] cookies, String[] ssoDomainList) {
        ...
        if (KernelContext.context != null) {
            if (cookies != null) {
                ...
                for (String cookie : cookies) {
                    if (!TextUtils.isEmpty(cookie)) {
                        try {
                            ...
                            if (TextUtils.equals(cook.domain, ".taobao.com")) {
                ...
                if (this.mCookies != null) {
                    FileUtils.writeFileData(KernelContext.context, "cookies", TextUtils.join("\u0005", cookies));
                }
            } else {
                clearCookies();
            }
    ...
    /* JADX WARNING: type inference failed for: r14v31, types: [java.lang.Object[]] */
    ...
    public void clearCookies() {
        /*
            ...
            com.ali.auth.third.core.trace.SDKLogger.e(r14, r15)
            android.content.Context r14 = com.ali.auth.third.core.context.KernelContext.getApplicationContext()
            ...
            java.lang.String r4 = com.ali.auth.third.core.util.FileUtils.readFileData(r14, r15)
            ...
            com.ali.auth.third.core.trace.SDKLogger.d(r14, r15)
        ...
        L_0x0071:
            ...
            com.ali.auth.third.core.cookies.LoginCookie r2 = com.ali.auth.third.core.cookies.LoginCookieUtils.parseCookie(r3)     // Catch:{ Throwable -> 0x00b8 }
        ...
        L_0x008e:
            ...
            goto L_0x0071
        L_0x0091:
            java.lang.String r13 = com.ali.auth.third.core.cookies.LoginCookieUtils.getHttpDomin(r2)     // Catch:{ Throwable -> 0x00b8 }
            com.ali.auth.third.core.cookies.LoginCookieUtils.expiresCookies(r2)     // Catch:{ Throwable -> 0x00b8 }
            com.ali.auth.third.core.WebViewProxy r17 = com.ali.auth.third.core.cookies.CookieManagerService.getWebViewProxy()     // Catch:{ Throwable -> 0x00b8 }
        ...
        L_0x00bd:
            r11 = 0
            com.ali.auth.third.core.service.impl.CredentialManager r14 = com.ali.auth.third.core.service.impl.CredentialManager.INSTANCE     // Catch:{ Exception -> 0x0123 }
            com.ali.auth.third.core.model.InternalSession r14 = r14.getInternalSession()     // Catch:{ Exception -> 0x0123 }
        ...
        L_0x00fb:
            ...
            com.ali.auth.third.core.cookies.LoginCookie r3 = (com.ali.auth.third.core.cookies.LoginCookie) r3
        ...
        L_0x0128:
            r3.domain = r10
            java.lang.String r13 = com.ali.auth.third.core.cookies.LoginCookieUtils.getHttpDomin(r3)
            com.ali.auth.third.core.cookies.LoginCookieUtils.expiresCookies(r3)
            com.ali.auth.third.core.WebViewProxy r17 = com.ali.auth.third.core.cookies.CookieManagerService.getWebViewProxy()
        ...
        L_0x0144:
            ...
            com.ali.auth.third.core.util.FileUtils.writeFileData(r14, r15, r16)
        L_0x015e:
            java.lang.String r14 = "clearCookies"
            java.lang.String r15 = "into clearCookies reset cookie finish"
            com.ali.auth.third.core.trace.SDKLogger.e(r14, r15)
            com.ali.auth.third.core.WebViewProxy r14 = com.ali.auth.third.core.cookies.CookieManagerService.getWebViewProxy()
