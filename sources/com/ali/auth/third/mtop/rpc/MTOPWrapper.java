...
public class MTOPWrapper {
    ...
    public <V> RpcResponse<V> post(RpcRequest rpcRequest, Class<V> v, String userId) {
        ...
        try {
            MtopBuilder mtopBuilder = Mtop.instance(KernelContext.context).build(buildMtopRequest(rpcRequest), MemberSDK.ttid).reqMethod(MethodEnum.POST).setBizId(94).setConnectionTimeoutMilliSecond(10000);
    ...
    private <V> RpcResponse<V> getBizRpcResponse(MtopResponse mtopResponse, Class<V> v) {
        try {
            return getvRpcResponse(mtopResponse, v);
        } catch (Exception e) {
            e.printStackTrace();
            return null;
        }
    ...
    private <V> com.ali.auth.third.core.model.RpcResponse<V> getvRpcResponse(mtopsdk.mtop.domain.MtopResponse r7, java.lang.Class<V> r8) throws org.json.JSONException {
        /*
            r6 = this;
            com.ali.auth.third.core.model.RpcResponse r4 = new com.ali.auth.third.core.model.RpcResponse
            r4.<init>()
            ...
            java.lang.String r5 = "returnValue"
            java.lang.String r5 = r0.optString(r5)
            java.lang.Object r5 = com.ali.auth.third.core.util.JSONUtils.parseStringValue(r5, r8)
            r4.returnValue = r5
        L_0x0065:
            return r4
        */
        throw new UnsupportedOperationException("Method not decompiled: com.ali.auth.third.mtop.rpc.MTOPWrapper.getvRpcResponse(mtopsdk.mtop.domain.MtopResponse, java.lang.Class):com.ali.auth.third.core.model.RpcResponse");
    }
    ...
    public <T> void remoteBusiness(RpcRequest request, final Class<T> resultType, final RpcRequestCallbackWithCode rpcRequestCallback) {
        if (request != null && rpcRequestCallback != null) {
            try {
                MtopBusiness business = MtopBusiness.build(buildMtopRequest(request), MemberSDK.ttid);
                business.addListener((MtopListener) new IRemoteBaseListener() {
                    ...
                    public void onSystemError(int requestType, MtopResponse response, Object requestContext) {
                        ...
                        try {
                            ...
                            rpcRequestCallback.onSystemError(errorCode, (RpcResponse) null);
                        }
                    }
                });
