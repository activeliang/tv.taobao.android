...
public class FadeInBitmapDisplayer implements BitmapDisplayer {
    ...
    public FadeInBitmapDisplayer(int durationMillis2, boolean animateFromNetwork2, boolean animateFromDisc2, boolean animateFromMemory2) {
        this.durationMillis = durationMillis2;
        this.animateFromNetwork = animateFromNetwork2;
        this.animateFromDisc = animateFromDisc2;
