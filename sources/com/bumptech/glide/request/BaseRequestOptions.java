...
public abstract class BaseRequestOptions<T extends BaseRequestOptions<T>> implements Cloneable {
    ...
    public T transform(@android.support.annotation.NonNull com.bumptech.glide.load.Transformation<android.graphics.Bitmap> r4, boolean r5) {
        /*
            r3 = this;
            boolean r1 = r3.isAutoCloneEnabled
            if (r1 == 0) goto L_0x000d
            com.bumptech.glide.request.BaseRequestOptions r1 = r3.clone()
            com.bumptech.glide.request.BaseRequestOptions r1 = r1.transform((com.bumptech.glide.load.Transformation<android.graphics.Bitmap>) r4, (boolean) r5)
        L_0x000c:
            return r1
        L_0x000d:
    ...
    public <Y> T transform(@android.support.annotation.NonNull java.lang.Class<Y> r4, @android.support.annotation.NonNull com.bumptech.glide.load.Transformation<Y> r5, boolean r6) {
        ...
        L_0x000e:
            ...
            r0 = r0 | r1
            r3.fields = r0
            r3.isTransformationRequired = r2
        L_0x0036:
