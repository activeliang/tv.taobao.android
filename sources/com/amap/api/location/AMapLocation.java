...
public class AMapLocation extends Location implements Parcelable, Cloneable {
    ...
    public int p = 0;
    /* access modifiers changed from: private */
    public String q = BlitzServiceUtils.CSUCCESS;
    /* access modifiers changed from: private */
    public String r = "";
    /* access modifiers changed from: private */
    public int s = 0;
    /* access modifiers changed from: private */
    public double t = ClientTraceData.b.f47a;
    /* access modifiers changed from: private */
    public double u = ClientTraceData.b.f47a;
    /* access modifiers changed from: private */
    public int v = 0;
    /* access modifiers changed from: private */
    public String w = "";
    ...
    public String toString() {
        ...
        try {
            stringBuffer.append("latitude=" + this.t + Constant.INTENT_JSON_MARK);
            stringBuffer.append("longitude=" + this.u + Constant.INTENT_JSON_MARK);
            stringBuffer.append("province=" + this.d + Constant.INTENT_JSON_MARK);
            stringBuffer.append("coordType=" + this.B + Constant.INTENT_JSON_MARK);
            stringBuffer.append("city=" + this.e + Constant.INTENT_JSON_MARK);
            stringBuffer.append("district=" + this.f + Constant.INTENT_JSON_MARK);
            stringBuffer.append("cityCode=" + this.g + Constant.INTENT_JSON_MARK);
            stringBuffer.append("adCode=" + this.h + Constant.INTENT_JSON_MARK);
            stringBuffer.append("address=" + this.i + Constant.INTENT_JSON_MARK);
            stringBuffer.append("country=" + this.k + Constant.INTENT_JSON_MARK);
            stringBuffer.append("road=" + this.l + Constant.INTENT_JSON_MARK);
            stringBuffer.append("poiName=" + this.j + Constant.INTENT_JSON_MARK);
            stringBuffer.append("street=" + this.m + Constant.INTENT_JSON_MARK);
            stringBuffer.append("streetNum=" + this.n + Constant.INTENT_JSON_MARK);
            stringBuffer.append("aoiName=" + this.w + Constant.INTENT_JSON_MARK);
            stringBuffer.append("poiid=" + this.a + Constant.INTENT_JSON_MARK);
            stringBuffer.append("floor=" + this.b + Constant.INTENT_JSON_MARK);
            stringBuffer.append("errorCode=" + this.p + Constant.INTENT_JSON_MARK);
            stringBuffer.append("errorInfo=" + this.q + Constant.INTENT_JSON_MARK);
            stringBuffer.append("locationDetail=" + this.r + Constant.INTENT_JSON_MARK);
            stringBuffer.append("description=" + this.z + Constant.INTENT_JSON_MARK);
            stringBuffer.append("locationType=" + this.s + Constant.INTENT_JSON_MARK);
    ...
    public void writeToParcel(Parcel parcel, int i2) {
        ...
        try {
            ...
            en.a(th, "AMapLocation", "writeToParcel");
        }
    }
}
