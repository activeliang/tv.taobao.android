...
final class DetectionResult {
    ...
    public java.lang.String toString() {
        /*
            r11 = this;
            r6 = 0
            com.google.zxing.pdf417.decoder.DetectionResultColumn[] r5 = r11.detectionResultColumns
            r4 = r5[r6]
            if (r4 != 0) goto L_0x000f
            com.google.zxing.pdf417.decoder.DetectionResultColumn[] r5 = r11.detectionResultColumns
            int r6 = r11.barcodeColumnCount
            int r6 = r6 + 1
            r4 = r5[r6]
        L_0x000f:
            ...
            r2 = 0
        L_0x0016:
            com.google.zxing.pdf417.decoder.Codeword[] r5 = r4.getCodewords()     // Catch:{ Throwable -> 0x005c, all -> 0x0088 }
            int r5 = r5.length     // Catch:{ Throwable -> 0x005c, all -> 0x0088 }
            if (r2 >= r5) goto L_0x0096
            java.lang.String r5 = "CW %3d:"
            r7 = 1
            java.lang.Object[] r7 = new java.lang.Object[r7]     // Catch:{ Throwable -> 0x005c, all -> 0x0088 }
            r8 = 0
            java.lang.Integer r9 = java.lang.Integer.valueOf(r2)     // Catch:{ Throwable -> 0x005c, all -> 0x0088 }
            r7[r8] = r9     // Catch:{ Throwable -> 0x005c, all -> 0x0088 }
            r3.format(r5, r7)     // Catch:{ Throwable -> 0x005c, all -> 0x0088 }
            r0 = 0
        L_0x002e:
            int r5 = r11.barcodeColumnCount     // Catch:{ Throwable -> 0x005c, all -> 0x0088 }
            int r5 = r5 + 2
            if (r0 >= r5) goto L_0x008a
            com.google.zxing.pdf417.decoder.DetectionResultColumn[] r5 = r11.detectionResultColumns     // Catch:{ Throwable -> 0x005c, all -> 0x0088 }
            r5 = r5[r0]     // Catch:{ Throwable -> 0x005c, all -> 0x0088 }
        ...
        L_0x0046:
            com.google.zxing.pdf417.decoder.DetectionResultColumn[] r5 = r11.detectionResultColumns     // Catch:{ Throwable -> 0x005c, all -> 0x0088 }
            r5 = r5[r0]     // Catch:{ Throwable -> 0x005c, all -> 0x0088 }
            com.google.zxing.pdf417.decoder.Codeword[] r5 = r5.getCodewords()     // Catch:{ Throwable -> 0x005c, all -> 0x0088 }
            r1 = r5[r2]     // Catch:{ Throwable -> 0x005c, all -> 0x0088 }
        ...
        L_0x0062:
            ...
            r3.close()     // Catch:{ Throwable -> 0x009e }
        L_0x0067:
            throw r5
        L_0x0068:
            ...
            java.lang.Object[] r7 = new java.lang.Object[r7]     // Catch:{ Throwable -> 0x005c, all -> 0x0088 }
            r8 = 0
            int r9 = r1.getRowNumber()     // Catch:{ Throwable -> 0x005c, all -> 0x0088 }
            java.lang.Integer r9 = java.lang.Integer.valueOf(r9)     // Catch:{ Throwable -> 0x005c, all -> 0x0088 }
            r7[r8] = r9     // Catch:{ Throwable -> 0x005c, all -> 0x0088 }
            r8 = 1
            int r9 = r1.getValue()     // Catch:{ Throwable -> 0x005c, all -> 0x0088 }
            java.lang.Integer r9 = java.lang.Integer.valueOf(r9)     // Catch:{ Throwable -> 0x005c, all -> 0x0088 }
            r7[r8] = r9     // Catch:{ Throwable -> 0x005c, all -> 0x0088 }
            r3.format(r5, r7)     // Catch:{ Throwable -> 0x005c, all -> 0x0088 }
            goto L_0x0043
        ...
        L_0x008a:
            ...
            goto L_0x0016
        L_0x0096:
            java.lang.String r5 = r3.toString()     // Catch:{ Throwable -> 0x005c, all -> 0x0088 }
            r3.close()
            return r5
        L_0x009e:
            r7 = move-exception
