...
public final class RSSExpandedReader extends AbstractRSSReader {
    ...
    private static final int[][] WEIGHTS = {new int[]{1, 3, 9, 27, 81, 32, 96, 77}, new int[]{20, 60, 180, 118, Opcodes.INT_TO_SHORT, 7, 21, 63}, new int[]{Opcodes.MUL_LONG_2ADDR, Opcodes.SUB_INT, 13, 39, 117, Opcodes.DOUBLE_TO_FLOAT, 209, 205}, new int[]{193, Opcodes.MUL_LONG, 49, Opcodes.DIV_INT, 19, 57, Opcodes.ADD_DOUBLE, 91}, new int[]{62, Opcodes.USHR_INT_2ADDR, Opcodes.FLOAT_TO_LONG, Opcodes.USHR_LONG_2ADDR, 169, 85, 44, Opcodes.LONG_TO_INT}, new int[]{185, Opcodes.LONG_TO_FLOAT, Opcodes.SUB_LONG_2ADDR, Opcodes.INT_TO_CHAR, 4, 12, 36, 108}, new int[]{113, 128, Opcodes.MUL_DOUBLE, 97, 80, 29, 87, 50}, new int[]{150, 28, 84, 41, 123, 158, 52, Opcodes.SUB_LONG}, new int[]{46, Opcodes.DOUBLE_TO_INT, 203, 187, Opcodes.DOUBLE_TO_LONG, 206, Opcodes.SHR_LONG_2ADDR, 166}, new int[]{76, 17, 51, 153, 37, 111, SecExceptionCode.SEC_ERROR_INIT_NO_DATA_FILE, Opcodes.ADD_LONG}, new int[]{43, Opcodes.INT_TO_LONG, 176, 106, 107, 110, 119, Opcodes.MUL_INT}, new int[]{16, 48, Opcodes.ADD_INT, 10, 30, 90, 59, 177}, new int[]{109, 116, Opcodes.FLOAT_TO_DOUBLE, 200, 178, 112, 125, Opcodes.SHR_LONG}, new int[]{70, Opcodes.MUL_INT_LIT16, 208, 202, 184, 130, Opcodes.DIV_INT_2ADDR, SecExceptionCode.SEC_ERROR_INIT_SOURCE_DIR_NOT_EXISTED}, new int[]{Opcodes.LONG_TO_DOUBLE, Opcodes.REM_LONG_2ADDR, 151, 31, 93, 68, 204, Opcodes.DIV_LONG_2ADDR}, new int[]{148, 22, 66, 198, Opcodes.SUB_DOUBLE, 94, 71, 2}, new int[]{6, 18, 54, 162, 64, 192, 154, 40}, new int[]{Opcodes.INVOKE_INTERFACE_RANGE, 149, 25, 75, 14, 42, 126, 167}, new int[]{79, 26, 78, 23, 69, 207, 199, Opcodes.REM_DOUBLE}, new int[]{103, 98, 83, 38, 114, Opcodes.INT_TO_DOUBLE, 182, 124}, new int[]{161, 61, 183, 127, Opcodes.REM_FLOAT, 88, 53, 159}, new int[]{55, 165, 73, 8, 24, 72, 5, 15}, new int[]{45, Opcodes.FLOAT_TO_INT, Opcodes.XOR_LONG_2ADDR, 160, 58, Opcodes.DIV_DOUBLE, 100, 89}};
