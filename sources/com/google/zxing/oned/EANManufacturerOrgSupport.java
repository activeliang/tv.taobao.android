...
final class EANManufacturerOrgSupport {
    ...
    private synchronized void initIfNeeded() {
        if (this.ranges.isEmpty()) {
            ...
            add(new int[]{60, Opcodes.DOUBLE_TO_LONG}, "US/CA");
            ...
            add(new int[]{594}, "RO");
            add(new int[]{599}, "HU");
            add(new int[]{600, SecExceptionCode.SEC_ERROR_SIGNATRUE_INVALID_INPUT}, "ZA");
            add(new int[]{603}, "GH");
            add(new int[]{608}, "BH");
            add(new int[]{609}, "MU");
            add(new int[]{611}, "MA");
            ...
            add(new int[]{700, IMediaPlayer.MEDIA_INFO_STREAM_ABNORMAL_VIDEO_DTS}, "NO");
            add(new int[]{729}, "IL");
