...
public final class Decoder {
    private static final String[] DIGIT_TABLE = {"CTRL_PS", " ", "0", "1", "2", "3", "4", "5", Constants.LogTransferLevel.L6, Constants.LogTransferLevel.L7, Constants.LogTransferLevel.HIGH, "9", ",", ".", "CTRL_UL", "CTRL_US"};
    private static final String[] LOWER_TABLE = {"CTRL_PS", " ", "a", "b", "c", "d", "e", "f", "g", "h", UploadQueueMgr.MSGTYPE_INTERVAL, "j", "k", "l", DetailConfig.ONLINE, "n", "o", "p", "q", UploadQueueMgr.MSGTYPE_REALTIME, "s", "t", "u", "v", "w", "x", "y", "z", "CTRL_US", "CTRL_ML", "CTRL_DL", "CTRL_BS"};
    private static final String[] MIXED_TABLE = {"CTRL_PS", " ", "\u0001", "\u0002", "\u0003", "\u0004", "\u0005", "\u0006", "\u0007", "\b", "\t", "\n", "\u000b", "\f", "\r", "\u001b", "\u001c", "\u001d", "\u001e", "\u001f", Constant.NLP_CACHE_TYPE, "\\", Constant.BETTER_ASR, "_", "`", "|", "~", "", "CTRL_LL", "CTRL_UL", "CTRL_PL", "CTRL_BS"};
    private static final String[] PUNCT_TABLE = {"", "\r", "\r\n", ". ", ", ", ": ", Constant.BLURRY, "\"", Constant.INTENT_JSON_MARK, SymbolExpUtil.SYMBOL_DOLLAR, "%", "&", "'", "(", ")", "*", "+", ",", "-", ".", WVNativeCallbackUtil.SEPERATER, SymbolExpUtil.SYMBOL_COLON, SymbolExpUtil.SYMBOL_SEMICOLON, "<", "=", ">", WVUtils.URL_DATA_CHAR, "[", "]", "{", "}", "CTRL_UL"};
    ...
    public DecoderResult decode(AztecDetectorResult detectorResult) throws FormatException {
        ...
        DecoderResult decoderResult = new DecoderResult(convertBoolArrayToByteArray(correctedBits), getEncodedData(correctedBits), (List<byte[]>) null, (String) null);
