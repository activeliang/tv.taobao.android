...
final class State {
    ...
    public State addBinaryShiftChar(int index) {
        ...
        State result = new State(token2, mode2, this.binaryShiftByteCount + 1, bitCount2 + ((this.binaryShiftByteCount == 0 || this.binaryShiftByteCount == 31) ? 18 : this.binaryShiftByteCount == 62 ? 9 : 8));
    ...
    public BitArray toBitArray(byte[] text) {
        ...
        for (Token appendTo : symbols) {
            appendTo.appendTo(bitArray, text);
        }
        return bitArray;
    }
