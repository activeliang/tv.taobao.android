...
public class AppInfoModle {
    ...
    static Map<String, String> getAppInfoModle(Context context) {
        ...
        hashMap.put(A3_TARGET_SDK_VERSION, "" + AppInfoUtils.getTargetSdkVersion(context));
        ...
        hashMap.put(A7_CUR_PROCCESS_ID, "" + Process.myPid());
        ...
        hashMap.put(A10_TIMESTAMP, "" + System.currentTimeMillis());
