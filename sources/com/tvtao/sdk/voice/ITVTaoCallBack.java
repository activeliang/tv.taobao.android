...
public interface ITVTaoCallBack extends IInterface {
    ...
    void searchResult(String str, String str2) throws RemoteException;

    public static abstract class Stub extends Binder implements ITVTaoCallBack {
        private static final String DESCRIPTOR = "com.tvtao.sdk.voice.ITVTaoCallBack";
        static final int TRANSACTION_callback = 1;
        static final int TRANSACTION_searchResult = 2;
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                ...
                case 2:
                    data.enforceInterface(DESCRIPTOR);
                    searchResult(data.readString(), data.readString());
                    reply.writeNoException();
                    return true;
                case 1598968902:
        ...
        private static class Proxy implements ITVTaoCallBack {
            ...
            public void callback(String command) throws RemoteException {
            ...
            public void searchResult(String asr, String data) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
